...
$userAllowed = array("index.php","routeTest.php");//povolene stranky pre prihlaseneho pouzivatela
...
<nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
	...
	<div class="collapse navbar-collapse" id="navbarNavDropdown">
		<ul class="navbar-nav"> <!-- lave menu -->
			...
			<li class="nav-item"><a class="nav-link" href="routeTest.php">Test Trás</a>
			<li class="nav-item"><a class="nav-link" href="#">Dammit</a>
			<li class="nav-item"><a class="nav-link" href="#">I'm out of words</a>
			<?php endif; ?>
		</ul>
